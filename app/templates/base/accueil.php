...
<?php $this->start('principal') ?>
	...
	<section>
		...
		<div class="index_img"><img src="<?= $this->assetUrl('img/evenement1_img2.jpg') ?>" alt="description de l'evenement"></div>
		<div class="index_img"><img src="<?= $this->assetUrl('img/evenement1_img3.jpg') ?>" alt="description de l'evenement"></div>
		<p>Date</p>
		<p>Capacite</p>
		<p>Description</p>
	...
	<section>
		...
		<div class="index_img"><img src="<?= $this->assetUrl('img/evenement2_img1.jpg') ?>" alt="description de l'evenement"></div>
		<div class="index_img"><img src="<?= $this->assetUrl('img/evenement2_img2.jpg') ?>" alt="description de l'evenement"></div>
		<div class="index_img"><img src="<?= $this->assetUrl('img/evenement2_img3.jpg') ?>" alt="description de l'evenement"></div>
		<p>Date</p>
		<p>Capacite</p>
		<p>Description</p>
		<p>Nombre de participants</p>
